...
# Generate random large-scale FJSP instance
def generate_fjsp_instance(n_jobs=10, n_machines=6, min_ops=5, max_ops=7, min_time=1, max_time=7):
    operations = []
...
class LargeFJSP(Problem):
    def __init__(self, operations, num_jobs, num_machines):
        ...
        self.energy_rate = [i + 1 for i in range(num_machines)]  # E.g., machine 1: 1 unit/time, machine 6: 6 units/time
    ...
    def simulate(self, machine_assign, sequence):
        ...
        energy_used = [0] * self.num_machines
        ...
        for op_idx in sequence:
            ...
            energy_used[selected_machine] += proc_time * self.energy_rate[selected_machine]
...
algorithm = NSGA2WithLocalSearch(pop_size=40)
